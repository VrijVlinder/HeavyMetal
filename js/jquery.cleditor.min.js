jQuery(document).ready(function ($) {
    $.cleditor = {
        defaultOptions: {
            ...
            docCSSFile: "",
           //below here you can change the font color and style for the rich text side of cleditor 
            bodyStyle: "margin:4px; font:12pt Arial,Verdana; cursor:text;color:#fff;font-weight:bold;"
        },
        buttons: {
    ...
    BACKGROUND_COLOR = "backgroundColor",
        ...
        popups = {}, documentClickAssigned, buttons = $.cleditor.buttons;
            ...
            if (!success) {
                if ("cutcopypaste".indexOf(command) > -1)
                    showMessage(editor, "For security reasons, your browser does not support the " +
                        command + " command. Try using the keyboard shortcut or context menu instead.", button);
                else
